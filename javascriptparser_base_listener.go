...
func (s *BaseJavaScriptParserListener) EnterEmptyStatement(ctx *EmptyStatementContext) {}

// ExitEmptyStatement is called when production emptyStatement is exited.
func (s *BaseJavaScriptParserListener) ExitEmptyStatement(ctx *EmptyStatementContext) {}
...
func (s *BaseJavaScriptParserListener) EnterIdentifier(ctx *IdentifierContext) {}

// ExitIdentifier is called when production identifier is exited.
func (s *BaseJavaScriptParserListener) ExitIdentifier(ctx *IdentifierContext) {}
...
// EnterLet_ is called when production let_ is entered.
func (s *BaseJavaScriptParserListener) EnterLet_(ctx *Let_Context) {}

// ExitLet_ is called when production let_ is exited.
func (s *BaseJavaScriptParserListener) ExitLet_(ctx *Let_Context) {}
